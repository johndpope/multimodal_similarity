                ...
                while True:
                    try:
                        ...
                        if triplet_input is not None:
                            ...
                            err, metric_err, ver_err, reg_err, _, step, summ = sess.run(
                                    [total_loss, metric_loss, ver_loss, regularization_loss, train_op, global_step, summary_op],
                            ...
                            summary = tf.Summary(value=[tf.Summary.Value(tag="train_loss", simple_value=err),
                                tf.Summary.Value(tag="metric_loss", simple_value=metri_err),
                                tf.Summary.Value(tag="ver_loss", simple_value=ver_err),
                                tf.Summary.Value(tag="reg_loss", simple_value=reg_err),
