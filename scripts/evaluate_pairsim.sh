...
model_path="/mnt/work/honda_100h/results/sensors_pairsim_nohard_20180412-214038/sensors_pairsim_nohard.ckpt-32000"
...
python check_inconsistent_pairsim.py --model_path $model_path --feat $feat \
                                    --network $network --num_seg $num_seg \
                                    --gpu $gpu
